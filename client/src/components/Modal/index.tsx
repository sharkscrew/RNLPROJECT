...
const Modal: FC<ModalProps> = ({ isOpen, onClose, className, children, showCloseButton, isFullScreen }) => {
    ...
    const contentClasses = isFullScreen
        ? 'relative w-full h-full rounded-lg bg-white  flex flex-col' : 'relative w-full sm:max-w-md md:max-w-lg lg:max-w-2xl rounded-lg bg-white max-h-[90vh] flex flex-col';
